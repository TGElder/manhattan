...
import elder.manhattan.gui.MouseListener;
...
public class CityDrawer
{
	...
	private final List<CityDrawerLayer> layers = new ArrayList<CityDrawerLayer> ();
	...
	public CityDrawer(Simulation sim, int width, int height)
	{
		this.sim = sim;
		setWidth(width);
		setHeight(height);
	...
	public List<CityDrawerLayer> getLayers()
	{
		return layers;
	}
    ...
    public void refresh()
    {
	    ...
	    for (CityDrawerLayer layer : layers)
	    {
	    	layer.draw(this);
